...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.total_documents'
        db.add_column('title_issue', 'total_documents', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.total_documents'
        db.delete_column('title_issue', 'total_documents')
