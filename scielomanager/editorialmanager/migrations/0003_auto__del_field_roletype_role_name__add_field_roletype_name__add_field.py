...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RoleType.role_name'
        db.delete_column('editorialmanager_roletype', 'role_name')

        # Adding field 'RoleType.name'
        db.add_column('editorialmanager_roletype', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256),
                      keep_default=False)

        # Adding field 'EditorialMember.board'
        db.add_column('editorialmanager_editorialmember', 'board',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['editorialmanager.EditorialBoard']),
                      keep_default=False)


        # Changing field 'EditorialMember.link_cv'
        db.alter_column('editorialmanager_editorialmember', 'link_cv', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'RoleType.role_name'
        db.add_column('editorialmanager_roletype', 'role_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256),
                      keep_default=False)

        # Deleting field 'RoleType.name'
        db.delete_column('editorialmanager_roletype', 'name')

        # Deleting field 'EditorialMember.board'
        db.delete_column('editorialmanager_editorialmember', 'board_id')


        # Changing field 'EditorialMember.link_cv'
        db.alter_column('editorialmanager_editorialmember', 'link_cv', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))
