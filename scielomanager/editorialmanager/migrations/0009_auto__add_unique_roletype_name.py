...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RoleType', fields ['name']
        db.create_unique('editorialmanager_roletype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'RoleType', fields ['name']
        db.delete_unique('editorialmanager_roletype', ['name'])
