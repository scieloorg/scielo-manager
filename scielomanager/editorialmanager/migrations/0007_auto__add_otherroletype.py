...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtherRoleType'
        db.create_table('editorialmanager_otherroletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editorialmanager.EditorialMember'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Language'])),
        ))
        db.send_create_signal('editorialmanager', ['OtherRoleType'])


    def backwards(self, orm):
        # Deleting model 'OtherRoleType'
        db.delete_table('editorialmanager_otherroletype')
    ...
    models = {
        ...
        'editorialmanager.otherroletype': {
            'Meta': {'object_name': 'OtherRoleType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.Language']"}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['editorialmanager.EditorialMember']"}),
