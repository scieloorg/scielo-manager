...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EditorialMember.research_id'
        db.add_column('editorialmanager_editorialmember', 'research_id',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EditorialMember.orcid'
        db.add_column('editorialmanager_editorialmember', 'orcid',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EditorialMember.research_id'
        db.delete_column('editorialmanager_editorialmember', 'research_id')

        # Deleting field 'EditorialMember.orcid'
        db.delete_column('editorialmanager_editorialmember', 'orcid')
