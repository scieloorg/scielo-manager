...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('articletrack_comment', 'date')

        # Adding field 'Comment.created_at'
        db.add_column('articletrack_comment', 'created_at',
        ...
        db.add_column('articletrack_comment', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comment.date'
        db.add_column('articletrack_comment', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)
