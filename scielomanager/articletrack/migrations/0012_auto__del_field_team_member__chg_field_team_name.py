...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Team.member'
        db.delete_column('articletrack_team', 'member_id')
        ...
        db.alter_column('articletrack_team', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Adding field 'Team.member'
        db.add_column('articletrack_team', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='team', to=orm['auth.User']),
                      keep_default=False)
        ...
        # Changing field 'Team.name'
        db.alter_column('articletrack_team', 'name', self.gf('django.db.models.fields.TextField')())
