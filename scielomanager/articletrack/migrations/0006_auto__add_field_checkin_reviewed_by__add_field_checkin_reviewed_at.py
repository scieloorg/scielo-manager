...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkin.reviewed_by'
        db.add_column('articletrack_checkin', 'reviewed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkins_reviewed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Checkin.reviewed_at'
        db.add_column('articletrack_checkin', 'reviewed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkin.reviewed_by'
        db.delete_column('articletrack_checkin', 'reviewed_by_id')

        # Deleting field 'Checkin.reviewed_at'
        db.delete_column('articletrack_checkin', 'reviewed_at')
