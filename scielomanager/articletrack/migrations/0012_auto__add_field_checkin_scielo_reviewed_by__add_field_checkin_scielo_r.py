...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkin.scielo_reviewed_by'
        db.add_column('articletrack_checkin', 'scielo_reviewed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkins_scielo_reviewed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Checkin.scielo_reviewed_at'
        db.add_column('articletrack_checkin', 'scielo_reviewed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkin.scielo_reviewed_by'
        db.delete_column('articletrack_checkin', 'scielo_reviewed_by_id')

        # Deleting field 'Checkin.scielo_reviewed_at'
        db.delete_column('articletrack_checkin', 'scielo_reviewed_at')
