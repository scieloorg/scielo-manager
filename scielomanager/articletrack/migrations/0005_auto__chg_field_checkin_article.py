...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Checkin.article'
        db.alter_column('articletrack_checkin', 'article_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['articletrack.Article']))

    def backwards(self, orm):

        # Changing field 'Checkin.article'
        db.alter_column('articletrack_checkin', 'article_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['articletrack.Article']))
    ...
    models = {
        ...
        'articletrack.checkin': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'checkins'", 'to': "orm['articletrack.Article']"}),
