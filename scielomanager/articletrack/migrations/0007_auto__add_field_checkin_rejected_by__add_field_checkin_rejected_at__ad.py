...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkin.rejected_by'
        db.add_column('articletrack_checkin', 'rejected_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkins_rejected', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Checkin.rejected_at'
        db.add_column('articletrack_checkin', 'rejected_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Checkin.rejected_cause'
        db.add_column('articletrack_checkin', 'rejected_cause',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkin.rejected_by'
        db.delete_column('articletrack_checkin', 'rejected_by_id')

        # Deleting field 'Checkin.rejected_at'
        db.delete_column('articletrack_checkin', 'rejected_at')

        # Deleting field 'Checkin.rejected_cause'
        db.delete_column('articletrack_checkin', 'rejected_cause')
