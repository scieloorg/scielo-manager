...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articletrack_checkin', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkins', null=True, to=orm['articletrack.Article']),
                      keep_default=False)
    ...
    models = {
        ...
        'articletrack.checkin': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'checkins'", 'null': 'True', 'to': "orm['articletrack.Article']"}),
