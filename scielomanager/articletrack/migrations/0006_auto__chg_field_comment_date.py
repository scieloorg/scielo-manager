...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.date'
        db.alter_column('articletrack_comment', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Comment.date'
        db.alter_column('articletrack_comment', 'date', self.gf('django.db.models.fields.DateTimeField')())
