...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.checkin'
        db.delete_column('articletrack_article', 'checkin_id')


    def backwards(self, orm):
        # Adding field 'Article.checkin'
        db.add_column('articletrack_article', 'checkin',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='articles_checkin', to=orm['articletrack.Checkin']),
                      keep_default=False)
