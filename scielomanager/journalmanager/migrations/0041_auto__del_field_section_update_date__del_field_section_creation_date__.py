...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Section.update_date'
        db.delete_column('journalmanager_section', 'update_date')

        # Deleting field 'Section.creation_date'
        db.delete_column('journalmanager_section', 'creation_date')

        # Adding field 'Section.created'
        db.add_column('journalmanager_section', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)

        # Adding field 'Section.updated'
        db.add_column('journalmanager_section', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)

        # Adding field 'Institution.created'
        db.add_column('journalmanager_institution', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)

        # Adding field 'Institution.updated'
        db.add_column('journalmanager_institution', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Section.update_date'
        db.add_column('journalmanager_section', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)

        # Adding field 'Section.creation_date'
        db.add_column('journalmanager_section', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 2, 27), blank=True), keep_default=False)

        # Deleting field 'Section.created'
        db.delete_column('journalmanager_section', 'created')

        # Deleting field 'Section.updated'
        db.delete_column('journalmanager_section', 'updated')

        # Deleting field 'Institution.created'
        db.delete_column('journalmanager_institution', 'created')

        # Deleting field 'Institution.updated'
        db.delete_column('journalmanager_institution', 'updated')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'subscription': ('django.db.models.fields.CharField', [], {'default': "'na'", 'max_length': '4', 'blank': 'True'}),
