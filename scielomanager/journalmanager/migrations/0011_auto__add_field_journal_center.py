...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'center', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Institution'], null=True), keep_default=False)
