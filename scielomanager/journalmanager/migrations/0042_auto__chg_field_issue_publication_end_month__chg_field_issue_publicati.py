...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.publication_end_month'
        db.alter_column('journalmanager_issue', 'publication_end_month', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Issue.publication_start_month'
        db.alter_column('journalmanager_issue', 'publication_start_month', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Issue.publication_end_month'
        db.alter_column('journalmanager_issue', 'publication_end_month', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Issue.publication_start_month'
        db.alter_column('journalmanager_issue', 'publication_start_month', self.gf('django.db.models.fields.IntegerField')(default=None))
