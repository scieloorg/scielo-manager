...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.acronym'
        db.alter_column('journalmanager_journal', 'acronym', self.gf('django.db.models.fields.CharField')(max_length=16))


    def backwards(self, orm):
        
        # Changing field 'Journal.acronym'
        db.alter_column('journalmanager_journal', 'acronym', self.gf('django.db.models.fields.CharField')(max_length=8))
