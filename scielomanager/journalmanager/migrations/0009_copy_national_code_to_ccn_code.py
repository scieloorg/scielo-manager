...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for j in orm.Journal.objects.only('national_code').all():
            j.ccn_code = j.national_code
            j.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for j in orm.Journal.objects.only('national_code', 'ccn_code').all():
            j.national_code = j.ccn_code
            j.save()
