...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_journal_study_areas', (
        ...
        db.create_unique('journalmanager_journal_study_areas', ['journal_id', 'studyarea_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field study_areas on 'Journal'
        db.delete_table('journalmanager_journal_study_areas')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'studyareas': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'journals'", 'null': 'True', 'to': "orm['journalmanager.StudyArea']"}),
