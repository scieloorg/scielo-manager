...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.use_license'
        db.add_column('journalmanager_journal', 'use_license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.UseLicense'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.use_license'
        db.delete_column('journalmanager_journal', 'use_license_id')
