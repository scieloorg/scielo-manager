...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'pub_status_reason', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Journal.pub_status_changed_by'
        db.add_column('journalmanager_journal', 'pub_status_changed_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pub_status_changed_by', to=orm['auth.User']), keep_default=False)

        # Changing field 'Journal.pub_status'
        db.alter_column('journalmanager_journal', 'pub_status', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Adding field 'JournalPublicationEvents.reason'
        db.add_column('journalmanager_journalpublicationevents', 'reason', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'JournalPublicationEvents.changed_by'
        db.add_column('journalmanager_journalpublicationevents', 'changed_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.pub_status'
        db.alter_column('journalmanager_journal', 'pub_status', self.gf('django.db.models.fields.CharField')(default=1, max_length=16))

        # Deleting field 'JournalPublicationEvents.reason'
        db.delete_column('journalmanager_journalpublicationevents', 'reason')

        # Deleting field 'JournalPublicationEvents.changed_by'
        db.delete_column('journalmanager_journalpublicationevents', 'changed_by_id')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'pub_status': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
