...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Journal.sponsor'
        raise RuntimeError("Cannot reverse this migration. 'Journal.sponsor' and its values cannot be restored.")
