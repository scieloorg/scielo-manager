...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.medline_title'
        db.add_column('journalmanager_journal', 'medline_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Journal.medline_code'
        db.add_column('journalmanager_journal', 'medline_code', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.medline_title'
        db.delete_column('journalmanager_journal', 'medline_title')

        # Deleting field 'Journal.medline_code'
        db.delete_column('journalmanager_journal', 'medline_code')
