...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.is_available'
        db.add_column('journalmanager_section', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.is_available'
        db.delete_column('journalmanager_section', 'is_available')
