...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PendedForm.form_class'
        db.delete_column('journalmanager_pendedform', 'form_class')

        # Adding field 'PendedForm.view_name'
        db.add_column('journalmanager_pendedform', 'view_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)

        # Adding field 'PendedForm.user'
        db.add_column('journalmanager_pendedform', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PendedForm.form_class'
        raise RuntimeError("Cannot reverse this migration. 'PendedForm.form_class' and its values cannot be restored.")

        # Deleting field 'PendedForm.view_name'
        db.delete_column('journalmanager_pendedform', 'view_name')

        # Deleting field 'PendedForm.user'
        db.delete_column('journalmanager_pendedform', 'user_id')
