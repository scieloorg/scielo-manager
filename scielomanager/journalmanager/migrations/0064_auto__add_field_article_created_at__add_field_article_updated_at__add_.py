...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_article', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.is_visible'
        db.add_column('journalmanager_article', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Article.is_generated'
        db.add_column('journalmanager_article', 'is_generated',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('journalmanager_article', 'updated_at')

        # Deleting field 'Article.is_visible'
        db.delete_column('journalmanager_article', 'is_visible')

        # Deleting field 'Article.is_generated'
        db.delete_column('journalmanager_article', 'is_generated')
