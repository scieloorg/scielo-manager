...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PressReleaseArticle.article_pid'
        db.alter_column('journalmanager_pressreleasearticle', 'article_pid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PressReleaseArticle.article_pid'
        raise RuntimeError("Cannot reverse this migration. 'PressReleaseArticle.article_pid' and its values cannot be restored.")
    ...
    models = {
        ...
        'journalmanager.pressreleasearticle': {
            ...
            'article_pid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
