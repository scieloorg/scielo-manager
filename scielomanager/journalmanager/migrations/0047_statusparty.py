...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for st in orm.JournalPublicationEvents.objects.all():
            journal = orm.Journal.objects.get(pk=st.journal.pk)
            statusparty = orm.StatusParty()
            statusparty.publication_status = st
            statusparty.collection = st.journal.collection
