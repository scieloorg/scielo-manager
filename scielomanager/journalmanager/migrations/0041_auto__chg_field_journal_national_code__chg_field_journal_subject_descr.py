...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.national_code'
        db.alter_column('journalmanager_journal', 'national_code', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Journal.subject_descriptors'
        db.alter_column('journalmanager_journal', 'subject_descriptors', self.gf('django.db.models.fields.CharField')(max_length=1024))


    def backwards(self, orm):
        
        # Changing field 'Journal.national_code'
        db.alter_column('journalmanager_journal', 'national_code', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Journal.subject_descriptors'
        db.alter_column('journalmanager_journal', 'subject_descriptors', self.gf('django.db.models.fields.CharField')(max_length=512))
