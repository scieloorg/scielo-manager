...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JournalHist.d'
        db.alter_column('journalmanager_journalhist', 'd', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'JournalHist.d'
        db.alter_column('journalmanager_journalhist', 'd', self.gf('django.db.models.fields.DateTimeField')())
