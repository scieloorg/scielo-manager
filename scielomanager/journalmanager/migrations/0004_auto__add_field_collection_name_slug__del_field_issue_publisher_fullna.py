...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.name_slug'
        db.add_column('journalmanager_collection', 'name_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, db_index=True), keep_default=False)

        # Deleting field 'Issue.publisher_fullname'
        # db.delete_column('journalmanager_issue', 'publisher_fullname')


    def backwards(self, orm):

        # Deleting field 'Collection.name_slug'
        db.delete_column('journalmanager_collection', 'name_slug')

        # Adding field 'Issue.publisher_fullname'
        # db.add_column('journalmanager_issue', 'publisher_fullname', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)
    ...
    models = {
        ...
        'journalmanager.collection': {
            ...
            'name_slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'db_index': 'True'}),
