...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserCollections.user'
        db.delete_column('journalmanager_usercollections', 'user_id')

        # Adding field 'UserCollections.user_profile'
        db.add_column('journalmanager_usercollections', 'user_profile', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['journalmanager.UserProfile']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserCollections.user'
        db.add_column('journalmanager_usercollections', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['journalmanager.UserProfile']), keep_default=False)

        # Deleting field 'UserCollections.user_profile'
        db.delete_column('journalmanager_usercollections', 'user_profile_id')
    ...
    models = {
        ...
        'journalmanager.usercollections': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.UserProfile']"})
        },
