...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Issue.publisher_fullname'
        raise RuntimeError("Cannot reverse this migration. 'Issue.publisher_fullname' and its values cannot be restored.")
