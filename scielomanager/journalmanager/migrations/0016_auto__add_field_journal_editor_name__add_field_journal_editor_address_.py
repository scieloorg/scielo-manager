...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.publisher_country'
        db.alter_column('journalmanager_journal', 'publisher_country', self.gf('scielo_extensions.modelfields.CountryField')(max_length=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.publisher_country'
        db.alter_column('journalmanager_journal', 'publisher_country', self.gf('django.db.models.fields.CharField')(max_length=64))
