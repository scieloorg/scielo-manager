...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.url_main_collection'
        db.add_column('journalmanager_journal', 'url_main_collection', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Journal.url_online_submission'
        db.add_column('journalmanager_journal', 'url_online_submission', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Journal.url_journal'
        db.add_column('journalmanager_journal', 'url_journal', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Journal.id_provided_by_the_center'
        db.add_column('journalmanager_journal', 'id_provided_by_the_center', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.url_main_collection'
        db.delete_column('journalmanager_journal', 'url_main_collection')

        # Deleting field 'Journal.url_online_submission'
        db.delete_column('journalmanager_journal', 'url_online_submission')

        # Deleting field 'Journal.url_journal'
        db.delete_column('journalmanager_journal', 'url_journal')

        # Deleting field 'Journal.id_provided_by_the_center'
        db.delete_column('journalmanager_journal', 'id_provided_by_the_center')
