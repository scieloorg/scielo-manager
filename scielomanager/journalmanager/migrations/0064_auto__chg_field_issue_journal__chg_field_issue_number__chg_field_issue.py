...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('journalmanager_issue', 'journal_id', self.gf('django.db.models.fields.related.ForeignKey')(default=9999, to=orm['journalmanager.Journal']))

        # Changing field 'Issue.number'
        db.alter_column('journalmanager_issue', 'number', self.gf('django.db.models.fields.CharField')(default=9999, max_length=16))

        # Changing field 'Issue.publisher_fullname'
        db.alter_column('journalmanager_issue', 'publisher_fullname', self.gf('django.db.models.fields.CharField')(default=9999, max_length=128))

        # Changing field 'Issue.volume'
        db.alter_column('journalmanager_issue', 'volume', self.gf('django.db.models.fields.CharField')(default=9999, max_length=16))


    def backwards(self, orm):
        
        # Changing field 'Issue.journal'
        db.alter_column('journalmanager_issue', 'journal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Journal'], null=True))

        # Changing field 'Issue.number'
        db.alter_column('journalmanager_issue', 'number', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Issue.publisher_fullname'
        db.alter_column('journalmanager_issue', 'publisher_fullname', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Issue.volume'
        db.alter_column('journalmanager_issue', 'volume', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
