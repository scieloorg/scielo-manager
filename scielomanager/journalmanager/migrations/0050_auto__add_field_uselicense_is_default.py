...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UseLicense.is_default'
        db.add_column('journalmanager_uselicense', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UseLicense.is_default'
        db.delete_column('journalmanager_uselicense', 'is_default')
