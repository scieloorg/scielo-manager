...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.complement'
        # db.add_column('journalmanager_institution', 'complement', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Issue.publication_date'
        db.delete_column('journalmanager_issue', 'publication_date')

        # Adding field 'Issue.publication_start_month'
        db.add_column('journalmanager_issue', 'publication_start_month', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Issue.publication_end_month'
        db.add_column('journalmanager_issue', 'publication_end_month', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Issue.publication_year'
        db.add_column('journalmanager_issue', 'publication_year', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Institution.complement'
        # db.delete_column('journalmanager_institution', 'complement')

        # User chose to not deal with backwards NULL issues for 'Issue.publication_date'
        raise RuntimeError("Cannot reverse this migration. 'Issue.publication_date' and its values cannot be restored.")

        # Deleting field 'Issue.publication_start_month'
        db.delete_column('journalmanager_issue', 'publication_start_month')

        # Deleting field 'Issue.publication_end_month'
        db.delete_column('journalmanager_issue', 'publication_end_month')

        # Deleting field 'Issue.publication_year'
        db.delete_column('journalmanager_issue', 'publication_year')
