...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field editors on 'Journal'
        db.delete_table(db.shorten_name('journalmanager_journal_editors'))


    def backwards(self, orm):
        # Adding M2M table for field editors on 'Journal'
        m2m_table_name = db.shorten_name('journalmanager_journal_editors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('journal', models.ForeignKey(orm['journalmanager.journal'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['journal_id', 'user_id'])
