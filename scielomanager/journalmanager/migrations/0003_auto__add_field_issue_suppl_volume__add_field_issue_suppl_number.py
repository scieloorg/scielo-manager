...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.suppl_volume'
        db.add_column('journalmanager_issue', 'suppl_volume', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Issue.suppl_number'
        db.add_column('journalmanager_issue', 'suppl_number', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.suppl_volume'
        db.delete_column('journalmanager_issue', 'suppl_volume')

        # Deleting field 'Issue.suppl_number'
        db.delete_column('journalmanager_issue', 'suppl_number')
