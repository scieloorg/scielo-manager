...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'editor_address', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Journal.editor_email'
        db.add_column('journalmanager_journal', 'editor_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'Journal.publisher_name'
        db.add_column('journalmanager_journal', 'publisher_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)

        # Adding field 'Journal.publisher_country'
        db.add_column('journalmanager_journal', 'publisher_country', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Journal.publisher_state'
        db.add_column('journalmanager_journal', 'publisher_state', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Journal.publication_city'
        db.add_column('journalmanager_journal', 'publication_city', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='publishers', to=orm['journalmanager.Publisher']), keep_default=False)
        ...
        # Deleting field 'Journal.publisher_name'
        db.delete_column('journalmanager_journal', 'publisher_name')

        # Deleting field 'Journal.publisher_country'
        db.delete_column('journalmanager_journal', 'publisher_country')

        # Deleting field 'Journal.publisher_state'
        db.delete_column('journalmanager_journal', 'publisher_state')

        # Deleting field 'Journal.publication_city'
        db.delete_column('journalmanager_journal', 'publication_city')
    ...
    models = {
        ...
        'journalmanager.issue': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        'journalmanager.journal': {
            ...
            'editor_address': ('django.db.models.fields.TextField', [], {}),
            ...
            'final_year': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            ...
            'init_year': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'is_trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'publisher_country': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
