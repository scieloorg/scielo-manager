...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('journalmanager_journalindexcoverage', 'database')


    def backwards(self, orm):
        
        # Adding field 'JournalIndexCoverage.database'
        db.add_column('journalmanager_journalindexcoverage', 'database', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
