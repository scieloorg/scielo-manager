...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_issue', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.order'
        db.delete_column('journalmanager_issue', 'order')
