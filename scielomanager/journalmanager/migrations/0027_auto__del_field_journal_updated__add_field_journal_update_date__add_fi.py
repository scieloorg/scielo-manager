...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Journal.updated'
        db.delete_column('journalmanager_journal', 'updated')

        # Adding field 'Journal.update_date'
        db.add_column('journalmanager_journal', 'update_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Institution.update_date'
        db.add_column('journalmanager_institution', 'update_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Journal.updated'
        db.add_column('journalmanager_journal', 'updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Deleting field 'Journal.update_date'
        db.delete_column('journalmanager_journal', 'update_date')

        # Deleting field 'Institution.update_date'
        db.delete_column('journalmanager_institution', 'update_date')
