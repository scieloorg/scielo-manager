...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.logo'
        db.alter_column('journalmanager_collection', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Collection.logo'
        raise RuntimeError("Cannot reverse this migration. 'Collection.logo' and its values cannot be restored.")
