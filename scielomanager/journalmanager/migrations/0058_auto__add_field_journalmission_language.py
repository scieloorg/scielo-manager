...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JournalMission.language'
        db.add_column('journalmanager_journalmission', 'language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Language'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JournalMission.language'
        db.delete_column('journalmanager_journalmission', 'language_id')
