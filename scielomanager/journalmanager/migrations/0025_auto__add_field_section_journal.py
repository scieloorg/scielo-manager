...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_section', 'journal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Journal'], null=True), keep_default=False)
