...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for article in orm.Article.objects.only('es_updated_at', 'es_is_dirty',
                'articles_linkage_is_pending').all().iterator():
            orm.ArticleControlAttributes.objects.create(
                    article=article,
                    es_updated_at=article.es_updated_at,
                    es_is_dirty=article.es_is_dirty,
                    articles_linkage_is_pending=article.articles_linkage_is_pending)
