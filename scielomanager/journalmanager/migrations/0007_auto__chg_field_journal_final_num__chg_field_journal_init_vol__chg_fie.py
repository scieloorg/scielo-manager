...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.final_num'
        db.alter_column('journalmanager_journal', 'final_num', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Journal.init_vol'
        db.alter_column('journalmanager_journal', 'init_vol', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Journal.init_num'
        db.alter_column('journalmanager_journal', 'init_num', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Journal.final_vol'
        db.alter_column('journalmanager_journal', 'final_vol', self.gf('django.db.models.fields.CharField')(max_length=8))


    def backwards(self, orm):
        
        # Changing field 'Journal.final_num'
        db.alter_column('journalmanager_journal', 'final_num', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Journal.init_vol'
        db.alter_column('journalmanager_journal', 'init_vol', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Journal.init_num'
        db.alter_column('journalmanager_journal', 'init_num', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Journal.final_vol'
        db.alter_column('journalmanager_journal', 'final_vol', self.gf('django.db.models.fields.CharField')(max_length=4))
