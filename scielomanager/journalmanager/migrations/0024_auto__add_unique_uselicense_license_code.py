...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UseLicense', fields ['license_code']
        db.create_unique('journalmanager_uselicense', ['license_code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UseLicense', fields ['license_code']
        db.delete_unique('journalmanager_uselicense', ['license_code'])
