...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Journal.study_area'
        db.delete_column('journalmanager_journal', 'study_area')


    def backwards(self, orm):
        
        # Adding field 'Journal.study_area'
        db.add_column('journalmanager_journal', 'study_area', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
