...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_usercollections', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.UserProfile'])),
        ...
        # Deleting field 'UserProfile.collection'
        db.delete_column('journalmanager_userprofile', 'collection_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.collection'
        db.add_column('journalmanager_userprofile', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_collection', to=orm['journalmanager.Collection']), keep_default=False)
    ...
    models = {
        ...
        'journalmanager.usercollections': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.UserProfile']"})
        },
        'journalmanager.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'collection': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_collection'", 'symmetrical': 'False', 'through': "orm['journalmanager.UserCollections']", 'to': "orm['journalmanager.Collection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
