...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.collection'
        db.add_column('journalmanager_journal', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='journals', null=True, to=orm['journalmanager.Collection']), keep_default=False)
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'journals'", 'null': 'True', 'to': "orm['journalmanager.Collection']"}),
