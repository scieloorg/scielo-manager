...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Center.is_provider_of_markup'
        db.delete_column('journalmanager_center', 'is_provider_of_markup')

        # Adding field 'Center.collection'
        db.add_column('journalmanager_center', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='collection', to=orm['journalmanager.Collection']), keep_default=False)
        ...
        db.add_column('journalmanager_institution', 'address_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=8), keep_default=False)
        ...
        # Deleting field 'Journal.institution'
        db.delete_column('journalmanager_journal', 'institution_id')

        # Adding field 'Journal.publisher'
        db.add_column('journalmanager_journal', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='journal_publisher', null=True, to=orm['journalmanager.Publisher']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Center.collection'
        ...
        # Adding field 'Institution.collection'
        db.add_column('journalmanager_institution', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='publisher_collection', to=orm['journalmanager.Collection']), keep_default=False)
        ...
        # Adding field 'Journal.institution'
        db.add_column('journalmanager_journal', 'institution', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='journal_institution', to=orm['journalmanager.Institution']), keep_default=False)
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'journal_publisher'", 'null': 'True', 'to': "orm['journalmanager.Publisher']"}),
