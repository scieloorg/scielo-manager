...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for issue in orm.Issue.objects.filter(type='supplement'):
            issue.suppl_text = issue.suppl_volume or issue.suppl_number
            issue.save()
    ...
    def backwards(self, orm):
        ...
        for issue in orm.Issue.objects.filter(type='supplement'):
            if issue.volume:
                issue.suppl_volume = issue.suppl_text
            else:
                issue.suppl_number = issue.suppl_text
