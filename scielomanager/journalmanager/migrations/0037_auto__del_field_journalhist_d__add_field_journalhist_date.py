...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_journalhist', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 2, 16), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'JournalHist.d'
        raise RuntimeError("Cannot reverse this migration. 'JournalHist.d' and its values cannot be restored.")
