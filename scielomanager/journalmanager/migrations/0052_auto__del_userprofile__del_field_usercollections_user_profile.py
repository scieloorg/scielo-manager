...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserCollections.user_profile'
        raise RuntimeError("Cannot reverse this migration. 'UserCollections.user_profile' and its values cannot be restored.")
