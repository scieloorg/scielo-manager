...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleHTMLRendition'
        db.create_table('journalmanager_articlehtmlrendition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(related_name='htmls', to=orm['journalmanager.Article'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('build_version', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('journalmanager', ['ArticleHTMLRendition'])

        # Adding unique constraint on 'ArticleHTMLRendition', fields ['article', 'lang']
        db.create_unique('journalmanager_articlehtmlrendition', ['article_id', 'lang'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArticleHTMLRendition', fields ['article', 'lang']
        db.delete_unique('journalmanager_articlehtmlrendition', ['article_id', 'lang'])

        # Deleting model 'ArticleHTMLRendition'
        db.delete_table('journalmanager_articlehtmlrendition')
