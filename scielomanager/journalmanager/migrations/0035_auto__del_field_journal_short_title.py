...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Journal.short_title'
        db.delete_column('journalmanager_journal', 'short_title')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Journal.short_title'
        raise RuntimeError("Cannot reverse this migration. 'Journal.short_title' and its values cannot be restored.")
