...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkBetweenArticles'
        db.create_table('journalmanager_linkbetweenarticles', (
        ...
        db.send_create_signal('journalmanager', ['LinkBetweenArticles'])

        # Adding field 'Article.links_to_related_articles_are_pending'
        db.add_column('journalmanager_article', 'links_to_related_articles_are_pending',
    ...
    def backwards(self, orm):
        # Deleting model 'LinkBetweenArticles'
        db.delete_table('journalmanager_linkbetweenarticles')

        # Deleting field 'Article.links_to_related_articles_are_pending'
        db.delete_column('journalmanager_article', 'links_to_related_articles_are_pending')
    ...
    models = {
        ...
        'journalmanager.article': {
            ...
            'doi': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'db_index': 'True'}),
            ...
            'links_to_related_articles_are_pending': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'related_articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['journalmanager.Article']", 'null': 'True', 'through': "orm['journalmanager.LinkBetweenArticles']", 'blank': 'True'}),
        ...
        'journalmanager.linkbetweenarticles': {
            'Meta': {'object_name': 'LinkBetweenArticles'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
