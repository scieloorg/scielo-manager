...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleControlAttributes'
        db.create_table('journalmanager_articlecontrolattributes', (
            ...
            ('articles_linkage_is_pending', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('article', self.gf('django.db.models.fields.related.OneToOneField')(related_name='control_attributes', unique=True, to=orm['journalmanager.Article'])),
        ))
        db.send_create_signal('journalmanager', ['ArticleControlAttributes'])


    def backwards(self, orm):
        # Deleting model 'ArticleControlAttributes'
        db.delete_table('journalmanager_articlecontrolattributes')
