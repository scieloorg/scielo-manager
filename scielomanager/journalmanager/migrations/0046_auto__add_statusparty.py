...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatusParty'
        db.create_table('journalmanager_statusparty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publication_status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statusparty_publication_status', to=orm['journalmanager.JournalPublicationEvents'])),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statusparty_collection', to=orm['journalmanager.Collection'])),
            ('journal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statusparty_journal', to=orm['journalmanager.Journal'])),
        ))
        db.send_create_signal('journalmanager', ['StatusParty'])

    def backwards(self, orm):

        # Deleting model 'StatusParty'
        db.delete_table('journalmanager_statusparty')
    ...
    models = {
        ...
        'journalmanager.statusparty': {
            'Meta': {'object_name': 'StatusParty'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statusparty_collection'", 'to': "orm['journalmanager.Collection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'journal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statusparty_journal'", 'to': "orm['journalmanager.Journal']"}),
            'publication_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statusparty_publication_status'", 'to': "orm['journalmanager.JournalPublicationEvents']"})
        },
