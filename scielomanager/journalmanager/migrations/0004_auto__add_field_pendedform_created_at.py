...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PendedForm.created_at'
        db.add_column('journalmanager_pendedform', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 5, 30), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PendedForm.created_at'
        db.delete_column('journalmanager_pendedform', 'created_at')
