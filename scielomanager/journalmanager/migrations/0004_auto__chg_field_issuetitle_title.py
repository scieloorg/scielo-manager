...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'IssueTitle.title'
        raise RuntimeError("Cannot reverse this migration. 'IssueTitle.title' and its values cannot be restored.")
