...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.short_title'
        db.add_column('journalmanager_journal', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True), keep_default=False)
