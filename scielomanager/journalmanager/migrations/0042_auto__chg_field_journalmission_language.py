...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JournalMission.language'
        db.alter_column('journalmanager_journalmission', 'language', self.gf('django.db.models.fields.CharField')(max_length=128))


    def backwards(self, orm):
        
        # Changing field 'JournalMission.language'
        db.alter_column('journalmanager_journalmission', 'language', self.gf('django.db.models.fields.CharField')(max_length=2))
