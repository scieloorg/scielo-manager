...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.type'
        db.add_column('journalmanager_issue', 'type',
                      self.gf('django.db.models.fields.CharField')(default='regular', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.type'
        db.delete_column('journalmanager_issue', 'type')
