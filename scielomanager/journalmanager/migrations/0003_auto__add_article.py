...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_article', (
            ...
            ('es_updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('es_is_dirty', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('issn_ppub', self.gf('django.db.models.fields.CharField')(max_length=9, db_index=True)),
            ('issn_epub', self.gf('django.db.models.fields.CharField')(max_length=9, db_index=True)),
        ))
