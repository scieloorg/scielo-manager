...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_article', (
            ...
            ('aid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('domain_key', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=2048, db_index=False)),
            ('is_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_aop', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('xml', self.gf('scielomanager.custom_fields.XMLSPSField')()),
            ('xml_version', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('journal', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='articles', null=True, to=orm['journalmanager.Journal'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='articles', null=True, to=orm['journalmanager.Issue'])),
            ('journal_title', self.gf('django.db.models.fields.CharField')(max_length=512, db_index=True)),
            ('issn_ppub', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, db_index=True)),
            ('issn_epub', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, db_index=True)),
        ))
    ...
    models = {
        ...
        'journalmanager.article': {
            ...
            'issn_epub': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'db_index': 'True'}),
            'issn_ppub': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'db_index': 'True'}),
