...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.url_journal'
        db.alter_column('journalmanager_journal', 'url_journal', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Journal.short_title'
        db.alter_column('journalmanager_journal', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Journal.previous_ahead_documents'
        db.alter_column('journalmanager_journal', 'previous_ahead_documents', self.gf('django.db.models.fields.IntegerField')(max_length=3))

        # Changing field 'Journal.url_online_submission'
        db.alter_column('journalmanager_journal', 'url_online_submission', self.gf('django.db.models.fields.CharField')(max_length=128))
        ...
        # Changing field 'Journal.twitter_user'
        db.alter_column('journalmanager_journal', 'twitter_user', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Journal.final_year'
        db.alter_column('journalmanager_journal', 'final_year', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Journal.index_coverage'
        db.alter_column('journalmanager_journal', 'index_coverage', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Journal.current_ahead_documents'
        db.alter_column('journalmanager_journal', 'current_ahead_documents', self.gf('django.db.models.fields.IntegerField')(max_length=3))

        # Changing field 'Journal.medline_code'
        db.alter_column('journalmanager_journal', 'medline_code', self.gf('django.db.models.fields.CharField')(max_length=64))
        ...
        # Changing field 'Journal.notes'
        db.alter_column('journalmanager_journal', 'notes', self.gf('django.db.models.fields.TextField')(max_length=254))

        # Changing field 'Journal.medline_title'
        db.alter_column('journalmanager_journal', 'medline_title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Journal.url_journal'
        db.alter_column('journalmanager_journal', 'url_journal', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Journal.short_title'
        db.alter_column('journalmanager_journal', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Journal.previous_ahead_documents'
        db.alter_column('journalmanager_journal', 'previous_ahead_documents', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'Journal.url_online_submission'
        db.alter_column('journalmanager_journal', 'url_online_submission', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Journal.init_vol'
        db.alter_column('journalmanager_journal', 'init_vol', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Journal.twitter_user'
        db.alter_column('journalmanager_journal', 'twitter_user', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Journal.final_year'
        db.alter_column('journalmanager_journal', 'final_year', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Journal.index_coverage'
        db.alter_column('journalmanager_journal', 'index_coverage', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Journal.current_ahead_documents'
        db.alter_column('journalmanager_journal', 'current_ahead_documents', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'Journal.medline_code'
        db.alter_column('journalmanager_journal', 'medline_code', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Journal.init_num'
        db.alter_column('journalmanager_journal', 'init_num', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Journal.notes'
        db.alter_column('journalmanager_journal', 'notes', self.gf('django.db.models.fields.TextField')(max_length=254, null=True))

        # Changing field 'Journal.medline_title'
        db.alter_column('journalmanager_journal', 'medline_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
