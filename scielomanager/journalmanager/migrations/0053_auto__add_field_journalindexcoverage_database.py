...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JournalIndexCoverage.database'
        db.add_column('journalmanager_journalindexcoverage', 'database', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.IndexDatabase'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JournalIndexCoverage.database'
        db.delete_column('journalmanager_journalindexcoverage', 'database_id')
