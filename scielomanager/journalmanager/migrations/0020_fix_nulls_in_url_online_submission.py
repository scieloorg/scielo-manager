...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Journal.objects.filter(url_online_submission=None).update(url_online_submission='')

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Journal.objects.filter(url_online_submission='').update(url_online_submission=None)
