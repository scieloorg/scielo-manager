...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Institution.is_available'
        db.add_column('journalmanager_institution', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Institution.is_available'
        db.delete_column('journalmanager_institution', 'is_available')
