...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('journalmanager_issuetitle', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'IssueTitle.title'
        db.alter_column('journalmanager_issuetitle', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
