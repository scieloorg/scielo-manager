...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.title_iso'
        db.add_column('journalmanager_journal', 'title_iso', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.title_iso'
        db.delete_column('journalmanager_journal', 'title_iso')
