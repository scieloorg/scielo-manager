...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for journal in orm.Journal.objects.all():
            journal.collection = journal.collections.all()[0]
            journal.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for journal in orm.Journal.objects.all():
            journal.collections.add(journal.collection)
            journal.save()
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'journals'", 'null': 'True', 'to': "orm['journalmanager.Collection']"}),
