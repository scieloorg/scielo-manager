...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.collection'
        db.alter_column('journalmanager_journal', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['journalmanager.Collection']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.collection'
        db.alter_column('journalmanager_journal', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['journalmanager.Collection']))
