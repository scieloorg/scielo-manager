...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.legacy_code'
        db.add_column('journalmanager_section', 'legacy_code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.legacy_code'
        db.delete_column('journalmanager_section', 'legacy_code')
