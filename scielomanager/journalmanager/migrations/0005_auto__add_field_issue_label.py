...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.label'
        db.add_column('journalmanager_issue', 'label', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=16, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.label'
        db.delete_column('journalmanager_issue', 'label')
