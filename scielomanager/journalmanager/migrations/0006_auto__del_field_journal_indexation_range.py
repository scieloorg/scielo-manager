...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Journal.indexation_range'
        db.delete_column('journalmanager_journal', 'indexation_range')


    def backwards(self, orm):
        
        # Adding field 'Journal.indexation_range'
        db.add_column('journalmanager_journal', 'indexation_range', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
