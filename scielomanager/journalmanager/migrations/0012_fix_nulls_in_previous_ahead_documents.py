...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Journal.objects.filter(previous_ahead_documents=None).update(previous_ahead_documents=0)

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Journal.objects.filter(previous_ahead_documents=0).update(previous_ahead_documents=None)
