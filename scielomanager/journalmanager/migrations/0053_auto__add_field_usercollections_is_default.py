...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserCollections.is_default'
        db.add_column('journalmanager_usercollections', 'is_default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserCollections.is_default'
        db.delete_column('journalmanager_usercollections', 'is_default')
