...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.suppl_text'
        db.add_column('journalmanager_issue', 'suppl_text',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.suppl_text'
        db.delete_column('journalmanager_issue', 'suppl_text')
