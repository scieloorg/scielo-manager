...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.url_journal'
        db.alter_column('journalmanager_journal', 'url_journal', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Journal.url_online_submission'
        db.alter_column('journalmanager_journal', 'url_online_submission', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
