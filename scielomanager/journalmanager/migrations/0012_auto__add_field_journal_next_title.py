...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.next_title'
        db.add_column('journalmanager_journal', 'next_title', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['journalmanager.Journal'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.next_title'
        db.delete_column('journalmanager_journal', 'next_title_id')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'center': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.Institution']", 'null': 'True'}),
            ...
            'next_title': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.Journal']", 'null': 'True', 'blank': 'True'}),
        ...
        'journalmanager.journalhist': {
            ...
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'journal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journalmanager.Journal']"}),
