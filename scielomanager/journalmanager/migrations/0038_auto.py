...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Journal', fields ['eletronic_issn']
        db.create_index('journalmanager_journal', ['eletronic_issn'])

        # Adding index on 'Journal', fields ['print_issn']
        db.create_index('journalmanager_journal', ['print_issn'])


    def backwards(self, orm):
        
        # Removing index on 'Journal', fields ['print_issn']
        db.delete_index('journalmanager_journal', ['print_issn'])

        # Removing index on 'Journal', fields ['eletronic_issn']
        db.delete_index('journalmanager_journal', ['eletronic_issn'])
