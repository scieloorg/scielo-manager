...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('journalmanager_section', 'title', self.gf('django.db.models.fields.CharField')(default=datetime.date(2012, 2, 29), max_length=256))
    ...
    def backwards(self, orm):
        ...
        db.add_column('journalmanager_journal', 'subscription', self.gf('django.db.models.fields.CharField')(default='na', max_length=4, blank=True), keep_default=False)

        # Changing field 'Section.title'
        db.alter_column('journalmanager_section', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Section.journal'
        db.alter_column('journalmanager_section', 'journal_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2012, 2, 29), to=orm['journalmanager.Journal']))
