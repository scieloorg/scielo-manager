...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_journal_editors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('journal', models.ForeignKey(orm['journalmanager.journal'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('journalmanager_journal_editors', ['journal_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field editors on 'Journal'
        db.delete_table('journalmanager_journal_editors')
