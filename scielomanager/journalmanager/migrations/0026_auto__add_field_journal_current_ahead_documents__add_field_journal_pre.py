...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Journal.current_ahead_documents'
        db.add_column('journalmanager_journal', 'current_ahead_documents', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Journal.previous_ahead_documents'
        db.add_column('journalmanager_journal', 'previous_ahead_documents', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.current_ahead_documents'
        db.delete_column('journalmanager_journal', 'current_ahead_documents')

        # Deleting field 'Journal.previous_ahead_documents'
        db.delete_column('journalmanager_journal', 'previous_ahead_documents')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'current_ahead_documents': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'previous_ahead_documents': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
