...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.label'
        db.alter_column('journalmanager_issue', 'label', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))


    def backwards(self, orm):
        
        # Changing field 'Issue.label'
        db.alter_column('journalmanager_issue', 'label', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
