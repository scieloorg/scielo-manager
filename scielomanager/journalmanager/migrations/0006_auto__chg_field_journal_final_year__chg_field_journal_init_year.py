...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.final_year'
        db.alter_column('journalmanager_journal', 'final_year', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Journal.init_year'
        db.alter_column('journalmanager_journal', 'init_year', self.gf('django.db.models.fields.CharField')(max_length=16))
