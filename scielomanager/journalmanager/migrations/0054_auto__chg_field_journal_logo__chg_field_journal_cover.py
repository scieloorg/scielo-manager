...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.logo'
        db.alter_column('journalmanager_journal', 'logo', self.gf('scielomanager.custom_fields.ContentTypeRestrictedFileField')(max_length=100, null=True))

        # Changing field 'Journal.cover'
        db.alter_column('journalmanager_journal', 'cover', self.gf('scielomanager.custom_fields.ContentTypeRestrictedFileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Journal.logo'
        db.alter_column('journalmanager_journal', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Journal.cover'
        db.alter_column('journalmanager_journal', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
