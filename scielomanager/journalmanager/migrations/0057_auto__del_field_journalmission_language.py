...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('journalmanager_journalmission', 'language')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'JournalMission.language'
        raise RuntimeError("Cannot reverse this migration. 'JournalMission.language' and its values cannot be restored.")
