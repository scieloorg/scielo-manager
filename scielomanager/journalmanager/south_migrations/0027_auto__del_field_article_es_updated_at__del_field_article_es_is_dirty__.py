...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.es_updated_at'
        db.delete_column('journalmanager_article', 'es_updated_at')

        # Deleting field 'Article.es_is_dirty'
        db.delete_column('journalmanager_article', 'es_is_dirty')
    ...
    def backwards(self, orm):
        # Adding field 'Article.es_updated_at'
        db.add_column('journalmanager_article', 'es_updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.es_is_dirty'
        db.add_column('journalmanager_article', 'es_is_dirty',
