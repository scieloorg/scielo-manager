...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.publisher_name'
        db.alter_column('journalmanager_journal', 'publisher_name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'ArticleHTMLRendition.file'
        db.alter_column('journalmanager_articlehtmlrendition', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

        # Changing field 'ArticleAsset.file'
        db.alter_column('journalmanager_articleasset', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Journal.publisher_name'
        db.alter_column('journalmanager_journal', 'publisher_name', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'ArticleHTMLRendition.file'
        db.alter_column('journalmanager_articlehtmlrendition', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'ArticleAsset.file'
        db.alter_column('journalmanager_articleasset', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
