...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.journal'
        db.add_column('journalmanager_section', 'journal', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['journalmanager.Journal']), keep_default=False)

        # Adding field 'Section.language'
        db.add_column('journalmanager_section', 'language', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.journal'
        db.delete_column('journalmanager_section', 'journal_id')

        # Deleting field 'Section.language'
        db.delete_column('journalmanager_section', 'language')
    ...
    models = {
        ...
        'journalmanager.section': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'journal': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['journalmanager.Journal']"}),
