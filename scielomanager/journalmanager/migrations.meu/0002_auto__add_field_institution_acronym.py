...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.acronym'
        db.add_column('journalmanager_institution', 'acronym', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=16, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.acronym'
        db.delete_column('journalmanager_institution', 'acronym')
