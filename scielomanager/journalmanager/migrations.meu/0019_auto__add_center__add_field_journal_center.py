...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Center'
        db.create_table('journalmanager_center', (
            ...
            ('is_provider_of_markup', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('journalmanager', ['Center'])

        # Adding field 'Journal.center'
        db.add_column('journalmanager_journal', 'center', self.gf('django.db.models.fields.related.ForeignKey')(related_name='center_id', null=True, to=orm['journalmanager.Center']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Center'
        db.delete_table('journalmanager_center')

        # Deleting field 'Journal.center'
        db.delete_column('journalmanager_journal', 'center_id')
