...
class Collection(caching.base.CachingMixin, models.Model):
    ...
    acronym = models.CharField(_('Sigla'), max_length=16, db_index=True, blank=True, help_text=helptexts.COLLECTION__ACRONYM)
    country = models.CharField(_('Country'), max_length=32, help_text=helptexts.COLLECTION__COUNTRY)
    state = models.CharField(_('State'), max_length=32, null=False, blank=True, help_text=helptexts.COLLECTION__STATE)
    city = models.CharField(_('City'), max_length=32, null=False, blank=True, help_text=helptexts.COLLECTION__CITY)
    address = models.TextField(_('Address'), help_text=helptexts.COLLECTION__ADDRESS)
    address_number = models.CharField(_('Number'), max_length=8, help_text=helptexts.COLLECTION__ADDRESS_NUMBER)
    address_complement = models.CharField(_('Complement'), max_length=128, null=False, blank=True, help_text=helptexts.COLLECTION__ADDRESS_COMPLEMENT)
    zip_code = models.CharField(_('Zip Code'), max_length=16, null=True, blank=True, help_text=helptexts.COLLECTION__ZIP_CODE)
    phone = models.CharField(_('Phone Number'), max_length=16, null=False, blank=True, help_text=helptexts.COLLECTION__PHONE)
    fax = models.CharField(_('Fax Number'), max_length=16, null=False, blank=True, help_text=helptexts.COLLECTION__FAX)
    mail = models.EmailField(_('Email'), help_text=helptexts.COLLECTION__MAIL)
